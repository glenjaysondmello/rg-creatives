    ...
    <section className="bg-black text-white py-32 flex items-center justify-center min-h-[80vh] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          ...
          >
            Our specialized media teams operate invisibly but capture
            everything, delivering cinematic results that amplify your
            brand&apos;s story across Dubai and the UAE.
          </motion.p>
